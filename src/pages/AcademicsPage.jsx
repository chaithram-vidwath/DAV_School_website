      ...
      <section className="academics-environment">
        ...
        <div className="academics-environment__gallery">
          <img
            ...
            className="academics-env-img academics-env-img--main"
            onClick={() => setActiveImage({ src: environmentImg, title: "School Playground", description: "Spacious Playground for outdoor games and physical activities." })}
            style={{ cursor: 'pointer' }}
          />
          <img
            src={indoorImg}
            alt="Library Study Space"
            className="academics-env-img academics-env-img--sub"
            onClick={() => setActiveImage({ src: indoorImg, title: "Library Study Space", description: "Well-stocked Library to encourage reading and research habits." })}
            style={{ cursor: 'pointer' }}
          />
        </div>
      </section>
        ...
        >
          ...
          >
            <div className="gallery-lightbox__image">
              <img src={activeImage.src} alt={activeImage.title} loading="lazy" />
            </div>
